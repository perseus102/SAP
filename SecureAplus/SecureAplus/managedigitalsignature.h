...
class ManageDigitalSignature : public QWidget
{
	Q_OBJECT

public:
	ManageDigitalSignature(QWidget *parent = Q_NULLPTR);
...
private:
	...
	void setTrustedByDigitalSignature(TrustedBy_DigitalSignature mode);
};
