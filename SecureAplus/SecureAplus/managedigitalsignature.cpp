...
ManageDigitalSignature::ManageDigitalSignature(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
	...
	{
	case Not_Trusted:
		setTrustedByDigitalSignature(TrustedBy_DigitalSignature::Not_Trusted);
		break;

	case Trusted_By_Os:
		setTrustedByDigitalSignature(TrustedBy_DigitalSignature::Trusted_By_Os);
		break;

	case Trusted_By_Name:
		setTrustedByDigitalSignature(TrustedBy_DigitalSignature::Trusted_By_Name);
		break;

	case Trusted_By_Thumbprint:
		setTrustedByDigitalSignature(TrustedBy_DigitalSignature::Trusted_By_Thumbprint);
		break;
	...
	connect(m_trustBasedToggle, &Switch::released, this, &ManageDigitalSignature::trustBasedToggleClicked);
	connect(AppSetting::getInstance(), &AppSetting::signal_changeTheme, this, &ManageDigitalSignature::changeTheme);
	connect(m_nameInTrustedBtn, &SAPRadioButton::clicked, this, &ManageDigitalSignature::radioButtonClicked);
	connect(m_trustedByOSBtn, &SAPRadioButton::clicked, this, &ManageDigitalSignature::radioButtonClicked);
	connect(m_nameAndThumbprintBtn, &SAPRadioButton::clicked, this, &ManageDigitalSignature::radioButtonClicked);

}

ManageDigitalSignature::~ManageDigitalSignature()
{

}

void ManageDigitalSignature::changeTheme()
{
	setStyle();
}

void ManageDigitalSignature::radioButtonClicked()
{
...
void ManageDigitalSignature::setLabelText()
{
...
void ManageDigitalSignature::setStyle()
{
...
void ManageDigitalSignature::setAllowAppListVisible(bool isVisible)
{
...
void ManageDigitalSignature::trustBasedToggleClicked()
{
...
void ManageDigitalSignature::radioBtnClicked(DWORD n) {
...
void ManageDigitalSignature::onTrustByCertificateChanged(int value) {
	if (!IsRunByTrustedAccount())
	{
		return;
	}
...
void ManageDigitalSignature::setTrustedByDigitalSignature(TrustedBy_DigitalSignature mode)
{
	switch (mode)
	{
	case Not_Trusted:
